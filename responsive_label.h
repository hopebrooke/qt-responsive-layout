...
const std::map<QString, QString> kColours = {
        ...
        std::make_pair(kMenu,           "#29AB87"),
        std::make_pair(kSResultImage,   "#cff3ff"),
        std::make_pair(kSResultText,    "#aabdf5"),
        std::make_pair(kWishlist,       "#ffa78c"),
        std::make_pair(kSResultPrice,   "#aaf5d5")
    };
